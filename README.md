...
- <img src="https://img.shields.io/github/stars/KikoCisBot/otter?style=social" height="17" align="texttop"/> [Otter](https://github.com/KikoCisBot/otter) - install anything on your machine using an AI agent — just point it at a README. Zero config, local-first (Ollama/LM Studio), single Rust binary

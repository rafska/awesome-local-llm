...
- [KaiROS AI](https://github.com/avikeid2007/Kairos.local) - a powerful local AI assistant for Windows with Model Catalog, CPU & GPU acceleration and inbuilt Local REST API

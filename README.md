...
- <img src="https://img.shields.io/github/stars/raullenchai/Rapid-MLX?style=social" height="17" align="texttop"/> [Rapid-MLX](https://github.com/raullenchai/Rapid-MLX) - fast Apple-Silicon-native LLM server (pure MLX), drop-in OpenAI & Anthropic API

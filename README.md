...
- <img src="https://img.shields.io/github/stars/youssofal/MTPLX?style=social" height="17" align="texttop"/> [MTPLX](https://github.com/youssofal/MTPLX) - native multi-token prediction inference engine and Mac app for Apple Silicon: exact speculative decoding at any temperature, OpenAI and Anthropic compatible server, works with Claude Code and OpenCode

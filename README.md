...
- <img src="https://img.shields.io/github/stars/vstep1/local-model-gateway?style=social" height="17" align="texttop"/> [Local Model Gateway](https://github.com/vstep1/local-model-gateway) - OpenAI-compatible local model gateway with shared GPU scheduling, a browser dashboard, and MCP tools for agent workflows

...
- <img src="https://img.shields.io/github/stars/Wecko-ai/modelfit?style=social" height="17" align="texttop"/> [modelfit](https://github.com/Wecko-ai/modelfit) - find the single best local model for your exact hardware (Mac, GPU, iPhone, RAM), backed by an open dataset

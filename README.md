...
- <img src="https://img.shields.io/github/stars/Orkas-AI/Orkas?style=social" height="17" align="texttop"/> [Orkas](https://github.com/Orkas-AI/Orkas) - local-first desktop workspace where a Commander decomposes goals and coordinates specialist AI agents with isolated skills, memory, and context ([website](https://orkas.ai?source=github_awesome_local_llm))

...
- <img src="https://img.shields.io/github/stars/ndom91/llama-dash?style=social" height="17" align="texttop"/> [llama-dash](https://github.com/ndom91/llama-dash) - an operator dashboard and AI gateway for llama-swap with request logs, API keys, routing rules, policies, and metrics

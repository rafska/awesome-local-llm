...
- <img src="https://img.shields.io/github/stars/Strategic-Automation/arachne?style=social" height="17" align="texttop"/> [arachne](https://github.com/Strategic-Automation/arachne) - DSPy-native autonomous agent runtime with graph weaving, parallel wave execution, self-healing, and MCP integration. Works with Ollama.

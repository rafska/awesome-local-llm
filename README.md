...
- <img src="https://img.shields.io/github/stars/shifulegend/project-zero?style=social" height="17" align="texttop"/> [project-zero](https://github.com/shifulegend/project-zero) - C99 zero-dependency LLM inference engine for BitNet ternary and GGUF dense models on CPU

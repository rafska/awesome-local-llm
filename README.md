...
- <img src="https://img.shields.io/github/stars/ASCIT31/Dark-Moon?style=social" height="17" align="texttop"/> [Dark-Moon](https://github.com/ASCIT31/Dark-Moon) - open-source autonomous AI penetration-testing platform with a fully local LLM orchestrator and a reversible local Privacy Gateway (deterministic tokenisation) so the model never sees real sensitive values

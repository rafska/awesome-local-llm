...
- <img src="https://img.shields.io/github/stars/sinabarimd/chief-of-staff?style=social" height="17" align="texttop"/> [chief-of-staff](https://github.com/sinabarimd/chief-of-staff) - reference implementation of a multi-agent personal operating system; eight Claude-based domain agents coordinated by an executive notification layer, plus a fully local voice frontend (Llama 3.1 8B INT4 via vLLM + WhisperLive + Kokoro on one consumer GPU, sub-300ms time-to-first-audio)

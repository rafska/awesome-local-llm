...
- <img src="https://img.shields.io/github/stars/aleksandrreva-eng/llama-monitor?style=social" height="17" align="texttop"/> [llama-monitor](https://github.com/aleksandrreva-eng/llama-monitor) - an always-on-top desktop widget for Windows that monitors a local llama.cpp server, showing context usage, prefill and generation speed, and the loaded model

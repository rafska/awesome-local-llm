...
- <img src="https://img.shields.io/github/stars/L-Forster/open-jet?style=social" height="17" align="texttop"/> [open-jet](https://github.com/L-Forster/open-jet) - a terminal coding agent for local models, with hardware-aware setup and a harness built for limited context windows

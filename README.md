...
- <img src="https://img.shields.io/github/stars/aistastudio/myc?style=social" height="17" align="texttop"/> [myc](https://github.com/aistastudio/myc) - fully local task-and-memory layer for coding agents: local embeddings, SQLite + sqlite-vec, no network calls, no API key

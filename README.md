...
- <img src="https://img.shields.io/github/stars/happy520ai/unified-ai-system?style=social" height="17" align="texttop"/> [unified-ai-system](https://github.com/happy520ai/unified-ai-system) - self-hosted AI + MCP gateway: local-first prompt enhancement, virtual keys with token budgets, response caching and an audit trail, served over an stdio MCP server

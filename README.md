...
- <img src="https://img.shields.io/github/stars/raullenchai/Rapid-MLX?style=social" height="17" align="texttop"/> [Rapid-MLX](https://github.com/raullenchai/Rapid-MLX) - OpenAI-compatible LLM inference server for Apple Silicon. 2-4x faster than Ollama with tool calling, reasoning separation, and prompt caching

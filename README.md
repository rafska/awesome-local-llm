...
- <img src="https://img.shields.io/github/stars/future-agi/agent-opt?style=social" height="17" align="texttop"/> [agent-opt](https://github.com/future-agi/agent-opt) - an open-source library for automated optimization of AI agent workflows with evaluation-driven prompt and config tuning
